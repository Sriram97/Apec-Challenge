    ...
    return new Column(
      ...
      children: <Widget>[
        ...
        new Padding(
          ...
          child: new Text(
            'I am an Artisan from PNG doing Bilum Bags for many years. A bilum is a string bag made by hand in Papua New Guinea. The bag can be made by a process known as looping or knotless netting or by crocheting.',
            style:
